...
type ProductCategoryProps = {
  ...
  /** Top eyebrow Badge text. Default "หมวดหมู่". */
  badgeLabel?: string;
  /** Main heading. Default "เลือกหมวดหมู่เพื่อเริ่มซื้อ". */
  heading?: string;
  /** Per-card "Products Available" suffix. Default "สินค้า". */
  unitLabel?: string;
  /** Bottom CTA — both label + href required to render. */
  ctaLabel?: string;
  ctaHref?: string;
};
...
const ProductCategory = ({
  productCards,
  badgeLabel = "หมวดหมู่",
  heading = "เลือกหมวดหมู่เพื่อเริ่มซื้อ",
  unitLabel = "สินค้า",
  ctaLabel,
  ctaHref,
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-lg">
                      {item.productNumber.toLocaleString()} {unitLabel}
                    </p>
                  </div>
                </div>
              </a>
