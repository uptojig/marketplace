      ...
      <div className='mx-auto max-w-7xl space-y-12 px-4 sm:space-y-16 sm:px-6 lg:space-y-24 lg:px-8'>
        ...
        <div className='flex flex-col gap-6'>
          {products.map((product, index) => {
            ...
            const imageWrapProps = product.productLink ? { href: product.productLink } : {}
            return (
                  ...
                  <div className='flex flex-col gap-6'>
                    <div className='flex flex-col gap-2'>
                      ...
                      <div className='flex items-center gap-3'>
                        ...
                        {product.productLink ? (
                          <a href={product.productLink} className='text-muted-foreground font-medium underline'>
                            {product.reviewCount} Reviews
                          </a>
                        ) : (
                          <span className='text-muted-foreground font-medium'>{product.reviewCount} Reviews</span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      {product.productLink ? (
                        <Button size='lg' asChild>
                          <a href={product.productLink}>Buy now</a>
                        </Button>
                      ) : (
