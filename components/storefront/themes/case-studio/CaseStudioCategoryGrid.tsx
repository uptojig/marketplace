...
const TYPES: {
...
}[] = [
  {
    key: 'cases',
    emoji: '📱',
    label: 'เคสและที่ป้องกัน',
    query: 'เคสและที่ป้องกัน',
    match: /เคสและที่ป้องกัน|เคส/i,
    blob: '#E0F2FE',
  },
  {
    key: 'mounts',
    emoji: '🧲',
    label: 'อุปกรณ์ยึดโทรศัพท์',
    query: 'อุปกรณ์ยึดโทรศัพท์',
    match: /อุปกรณ์ยึดโทรศัพท์/i,
    blob: '#FFE5EC',
  },
  {
    key: 'chargers',
    ...
    label: 'อุปกรณ์ชาร์จ',
    query: 'อุปกรณ์ชาร์จ',
    match: /อุปกรณ์ชาร์จ/i,
    blob: '#FEF3C7',
  },
  {
    key: 'car',
    emoji: '🚗',
    label: 'อุปกรณ์เสริมรถยนต์',
    query: 'อุปกรณ์เสริมรถยนต์',
    match: /อุปกรณ์เสริมรถยนต์/i,
    blob: '#FFEDD5',
  },
  {
    key: 'phone-accessories',
    emoji: '🎧',
    label: 'อุปกรณ์เสริมโทรศัพท์',
    query: 'อุปกรณ์เสริมโทรศัพท์',
    match: /อุปกรณ์เสริมโทรศัพท์/i,
    blob: '#DCFCE7',
  },
  {
    key: 'computer',
    emoji: '💻',
    label: 'อุปกรณ์เสริมคอมพิวเตอร์',
    query: 'อุปกรณ์เสริมคอมพิวเตอร์',
    match: /อุปกรณ์เสริมคอมพิวเตอร์/i,
    blob: '#F3E8FF',
  },
];
