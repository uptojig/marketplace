...
const DEFAULT_FAQS: FaqItem[] = [
  {
    ...
    a: 'เลือกสินค้าจากหน้าร้าน เพิ่มในตะกร้า ตรวจสอบรายการ จากนั้นกรอกที่อยู่และชำระเงินผ่าน ANYPAY ระบบจะส่งอีเมลยืนยันให้ทันที',
  },
  {
  ...
  {
    q: 'ชำระเงินอย่างไร?',
    a: 'ระบบของเรารองรับการชำระเงินอย่างปลอดภัยผ่านช่องทาง ANYPAY เพื่อความสะดวกและรวดเร็วในการทำรายการ',
  },
];
