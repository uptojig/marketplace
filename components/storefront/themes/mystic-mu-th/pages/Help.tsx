...
const PAGE_TITLES: Record<string, string> = {
  ...
  'size-guide': 'คู่มือขนาดวอลเปเปอร์',
};

const DEFAULT_FAQS: FaqItem[] = [
  {
    q: 'ดาวน์โหลดวอลเปเปอร์ยังไง?',
    a: 'เมื่อชำระเงินเรียบร้อย ระบบจะส่งลิงก์ดาวน์โหลดเข้าอีเมลของคุณภายใน 5 นาที · คลิกลิงก์เพื่อดาวน์โหลดไฟล์ JPG / PNG / PDF ได้ทันที',
  },
  {
    q: 'ไฟล์ใช้กับมือถือ + เดสก์ท็อปได้ไหม?',
    a: 'ได้ทุกอุปกรณ์ ⭐ ในชุดดาวน์โหลดมีไฟล์ขนาดทั้ง 1080p, 2K, 4K สำหรับมือถือ + แท็บเล็ต + คอมพิวเตอร์ + Smart TV · iOS / Android / Windows / macOS ใช้ได้หมด',
  },
  {
    q: 'วอลล์มงคลของจริงหรือเปล่า?',
    a: 'จริงสิ! ทุกชิ้นออกแบบโดยทีมที่ปรึกษาด้านศาสตร์เสริมดวง ผ่านการเลือกสี / องค์ประกอบ / ทิศทางตามหลักโหราศาสตร์ไทย และปลุกเสกโดยอาจารย์สายมูก่อนปล่อยให้ดาวน์โหลด',
  },
  {
    q: 'เลเวลอัพภายในกี่วัน?',
    a: 'ใส่วอลล์แล้วดวงดีขึ้นตั้งแต่วันแรก แต่ผลปังที่สุดมักเห็นภายใน 7-14 วัน ⭐ ลูกค้าหลายคนรายงานว่าการเงิน + ความรักดีขึ้นแบบจับต้องได้',
  },
  {
    q: 'คืนเงินได้ไหมถ้าไม่ปัง?',
    a: 'รับประกันความปัง · คืนเงินภายใน 7 วันหลังดาวน์โหลด ถ้าใช้วอลล์อย่างถูกวิธี (ตั้งเป็นวอลล์เพเปอร์หลัก 7 วันเต็ม) แล้วยังไม่เห็นการเปลี่ยนแปลง · ส่งหลักฐานมาทาง LINE ได้เลย',
  },
  {
    q: 'มีให้พิมพ์เป็นโปสเตอร์ไหม?',
    a: 'มี! เลือก "พิมพ์โปสเตอร์ EMS" ตอนสั่งซื้อ ทีมเราจะพิมพ์คุณภาพ 4K ลงกระดาษ Art Paper 250 แกรม ส่งถึงบ้านใน 1-2 วัน ค่าจัดส่ง 50-80 บาท',
  },
  {
    q: 'ใช้ค้าขายต่อได้ไหม?',
    a: 'ไม่ได้ครับ · วอลล์ของเราใช้สำหรับส่วนตัวเท่านั้น · ห้ามจำหน่ายต่อ / ใช้เชิงพาณิชย์ / แก้ไขแล้วขาย · ถ้าต้องการใช้เชิงพาณิชย์ ติดต่อทีมเราเพื่อรับใบอนุญาตพิเศษ',
  },
];
