...
const DEFAULT_DESCRIPTION =
  'เราคือสตูดิโอวอลเปเปอร์มงคลสายมู ผสมศาสตร์โหราศาสตร์ไทยเข้ากับงานออกแบบสไตล์ Mario เลเวลอัพ — เพราะเชื่อว่าทุกหน้าจอควรหนุนดวงคุณได้ทุกวัน 📱✨\n\nวอลล์ทุกชิ้นออกแบบด้วยศาสตร์เสริมดวงโบราณ ปลุกเสกโดยอาจารย์สายมูตัวจริง ก่อนปล่อยให้ลูกค้าดาวน์โหลด — ใส่แล้วดวงดี การงานปัง การเงินมา ความรักลื่นไหล';

const VALUES = [
  {
    icon: Coins,
    title: 'มูจริง ไม่ม่ง',
    desc: 'ทุกชิ้นปลุกเสกโดยอาจารย์สายมู ก่อนส่งถึงคุณ',
    bg: 'bg-[#FFD700]',
    fg: 'text-[#1A1A2E]',
  },
  {
    ...
    desc: 'ไม่ต้องรอจัดส่ง · เลเวลอัพได้ภายใน 5 นาที',
    bg: 'bg-[#E52521]',
    fg: 'text-white',
  },
  {
    icon: ShieldCheck,
    title: 'ลิขสิทธิ์แท้',
    desc: 'ออกแบบเอง · 4K · ไม่ใช้รูปก๊อปจากที่ไหน',
    bg: 'bg-[#009A4E]',
    fg: 'text-white',
  },
  {
    icon: Heart,
    title: 'รับประกันความปัง',
    desc: 'ใส่แล้วดวงไม่ขึ้น คืนเงิน 7 วัน',
    bg: 'bg-white',
    fg: 'text-[#1A1A2E]',
  },
];
...
const TIMELINE = [
  { year: '2566', label: 'เริ่มต้น', desc: 'ก่อตั้งสตูดิโอ ออกแบบวอลล์มงคล 12 ราศี' },
  { year: '2567', label: 'เลเวล 2', desc: 'ขยายไปสายเสริมโชคเฉพาะวันเกิด' },
  { year: '2568', label: 'มูเลเวลอัพ', desc: 'เปิดตัวคอลเลกชั่นสไตล์ Mario ผสมสายมู' },
];
      ...
      <section className="relative overflow-hidden bg-[#5C94FC] border-b-4 border-[#1A1A2E] px-4 py-16 md:py-24 pixel-clouds">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center md:text-left">
          ...
          <p className="mt-4 text-white font-bold text-base sm:text-lg max-w-xl drop-shadow-[2px_2px_0_#1A1A2E]">
            วอลเปเปอร์มงคลที่ออกแบบให้หนุนดวงคุณทุกวัน · สไตล์ Mario × สายมูไทย
          </p>
        </div>
      </section>
