...
export function PastelPackAnnouncementStrip({ messageDesktop, messageMobile }: PastelPackStripProps) {
  return (
    <div className="bg-[var(--shop-primary)] text-[var(--shop-accent)] px-4 py-2 text-center text-sm font-medium font-[family:var(--font-kanit)] flex items-center justify-center gap-2 tracking-wide">
