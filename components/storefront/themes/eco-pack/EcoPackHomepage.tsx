/**
 * EcoPackHomepage — server wrapper that fetches products + categories
 * and delegates to the designer's bespoke Homepage page via
 * EcoPackHomepageAdapter. Mirrors the wiring pattern of the other 12
...
import { EcoPackHomepageAdapter } from './adapters';

interface Props {
  store: Store;
}

export async function EcoPackHomepage({ store }: Props) {
