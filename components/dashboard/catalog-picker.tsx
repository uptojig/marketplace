...
/**
 * <CatalogPicker /> — extracted from the standalone /dashboard/catalog
 * page so we can also embed it in the tabbed
 * /dashboard/store/products/new flow alongside URL paste + manual form.
 *
 * Props:
 *   onSaved — fired after a successful bulk-save so the parent can
 *             redirect (e.g. back to the products list) or refresh
 *             a sibling tab. Standalone /catalog page passes nothing
 *             and the picker just shows its own "Added N" toast.
 */
