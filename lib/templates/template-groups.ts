...
export const TEMPLATE_GROUPS_MAP: Record<TemplateGroup, readonly TemplateId[]> = {
  ...
  'business-model': ['wholesale-b2b', 'eco-pack', 'bulkbox-industrial', 'smsup-plus-th'],
  specialty: ['handmade', 'sai-sing', 'mai-hatthakam', 'pigment-studio', 'casethep', 'casetify-clone', 'caseinw', 'sheetlab-formula', 'resume-studio-th'],
  everyday: ['everyday-retail', 'talad-see-sod'],
  taobao: ['taobao-style'],
  packaging: ['packaging-supply', 'pastel-pack', 'omnipack', 'blackwrapp'],
  neon: ['neon-festival'],
  'mystic-mu': ['mystic-mu-th', 'mu-wallpaper-th'],
  'edu-classroom': ['edu-classroom-th'],
  'vector-bazaar': ['vector-bazaar-th', 'iconmart-th'],
  'photo-vault': ['photo-vault-th'],
  'salepage-market': ['salepage-market-th'],
  'resume-forge': ['resume-forge-th'],
} as const;
