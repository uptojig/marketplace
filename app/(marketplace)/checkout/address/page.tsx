...
export default function CheckoutAddressPage() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[400px_1fr]">
      <CheckoutCart editable />

      <section className="space-y-4">
        {/* Status header */}
        <div className="flex items-center gap-3 shop-card !rounded-2xl p-4">
        ...
        <Button
          onClick={proceed}
          disabled={!selected}
          className="w-full bg-green-500 py-6 text-base font-semibold hover:bg-green-600"
        >
          จัดส่งตามที่อยู่นี้
        </Button>
      </section>
