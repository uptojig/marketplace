...
/**
 * Client-rendered catalog grid for /themes. Split out from page.tsx so
 * page.tsx can stay a server component (exports metadata) while the
 * "Details" CTA for coming-soon templates can still call
 * preventDefault() — onClick handlers can only live in client comps.
 */
...
/** Templates as serialized for the client — no `component` function ref. */
type CatalogTemplate = Omit<SalepageTemplate, 'component'>;

interface Props {
  templates: CatalogTemplate[];
}

export function ThemesCatalogGrid({ templates }: Props) {
  return (
