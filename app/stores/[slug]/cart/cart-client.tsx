          ...
          <>
            <FaqBlock
              ...
              items={[
                ...
                {
                  question: "สั่งซื้อสินค้าจากร้านนี้ยังไงดี?",
                  answer:
                    "เลือกสินค้าใส่ตะกร้า กดชำระเงิน กรอกที่อยู่จัดส่ง แล้วเลือกวิธีชำระเงิน — ระบบจะส่งอีเมลยืนยันคำสั่งซื้อให้ทันที",
                },
                {
                  question: "เปลี่ยน / คืนสินค้าได้ไหม?",
                  answer:
                    "เปลี่ยนหรือคืนได้ภายใน 7 วันหากสินค้ามีตำหนิจากโรงงาน ส่งกลับมาที่อยู่ร้านที่แจ้งไว้ในหน้าติดต่อ",
                },
                {
                  question: "ติดต่อร้านได้ทางไหน?",
                  answer:
                    "ดูช่องทางติดต่อ (อีเมล / โทรศัพท์ / Line / Facebook Messenger) ของร้านได้ในหน้า ติดต่อร้าน หรือกดไอคอนที่ส่วนท้ายของเว็บ",
                },
              ]}
            />
          </>
