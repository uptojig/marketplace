...
export function StoreRowActions({
  ...
  return (
    <>
      {topErr && (
        <p className="absolute right-0 -mt-6 max-w-[260px] truncate rounded bg-red-50 px-2 py-0.5 text-[10px] text-red-700 shadow">
          {topErr}
        </p>
      )}
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="space-y-2">
              ...
              <code className="mt-2 block break-all rounded bg-gray-100 px-2 py-1 text-xs">
                /stores/{storeSlug}
              </code>
            </DialogDescription>
          </DialogHeader>
